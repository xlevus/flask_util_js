...
#               0.2.7 | xlevus   | 2013-07-09 11:41:15 | added support for multiple url rules
#               0.2.8 | kohlmannj| 2013-07-09 11:41:15 | Removed url_encode implementation.
#
#=============================================================================
'''
            ...
            for k,v in org_url_map.items():
                ...
                for spec in v:
                    if "WEB_ROOT" in app.config:
                        url_rule = app.config["WEB_ROOT"] + (spec.rule)[1:]
                    else:
                        url_rule = spec.rule
